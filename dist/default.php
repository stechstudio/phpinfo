...
<div class="page-wrapper antialiased font-sans text-slate-700 dark:text-slate-400 fixed inset-0" x-data='Navigation' @keydown.window.slash.prevent="$refs.search.focus();">
    <header class="absolute top-0 h-16 lg:h-20 w-full flex items-center justify-between shadow py-4 px-6 xl:px-8 z-30 bg-white dark:bg-slate-800 dark:border-b border-slate-700">
    ...
    <div class="absolute w-full top-16 lg:top-20 bottom-0 overflow-y-auto bg-slate-100 dark:bg-slate-900">
