    ...
    <header class="fixed top-0 h-16 lg:h-20 w-full flex items-center justify-between shadow py-4 px-6 xl:px-8 bg-white z-10">
        ...
        <div class="flex-1 flex justify-center">
            <div class="relative group">
                ...
                <div x-show="!searchFocused && isUnfiltered()" class="absolute top-0 right-0 mt-2 mr-4 bg-white rounded px-2 py-1 text-xs text-gray-500">/</div>
            </div>
        </div>
            ...
            <aside class="fixed top-16 lg:top-20 bottom-0 overflow-y-auto hidden md:block flex-shrink-0 w-48 lg:w-56 xl:w-64 py-8 px-4 xl:px-8 space-y-px scroll-py-8">
                <template x-for="module in info.modules" :key="module.key">
                    <a x-show="module.shouldShow"
                       ...
                       class="px-4 py-1 rounded block" :class="selected == module.key ? 'bg-gray-200' : 'hover:bg-white'">
